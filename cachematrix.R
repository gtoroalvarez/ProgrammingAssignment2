## I created the makeCacheMatrix based on the example given for the vector - used a matrix and inverse function instead 
...
##I could have done  testmatrix <- makeCacheMatrix(matrix(1:4,2,2)) instead but I rather did it in 2 steps
